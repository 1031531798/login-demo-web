...
$.fn.addtabs = function (options) {
    ...
    Addtabs.options = $.extend({
        ...
        iframeHeight: $(document).height() - obj.children('.nav-tabs').outerHeight(), //固定TAB中IFRAME高度,根据需要自己修改
        method: 'init',
        contextmenu: true, //是否使用右键菜单
        onClose: function (id) { //关闭后回调函数
